...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-kou-21.133-kourovka-notebook-problem-21.133-e2eb4702-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/KOU-21.133"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-kou-21.133-kourovka-notebook-problem-21.133-e2eb4702-v1",
      "problem_contract_sha256": "f9605227c337d3d8341e20bae62f2bd0cdf3f9c2190b94fa6a26d0bc597ce4bf",
      "problem_id": "problem:um-kou-21.133-kourovka-notebook-problem-21.133-e2eb4702",
      "route_id": "route:um-kou-21.133-kourovka-notebook-problem-21.133-e2eb4702-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-kou-21.133-kourovka-notebook-problem-21.133-e2eb4702-source-fidelity-01",
      "graph_id": "graph:um-kou-21.133-kourovka-notebook-problem-21.133-e2eb4702-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-kou-21.133-kourovka-notebook-problem-21.133-e2eb4702-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-kou-21.133-kourovka-notebook-problem-21.133-e2eb4702-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Does a group need to have a subnormal abelian series if every countable subgroup of it has such a series?"
          },
          "statement_sha256": "8b4347ce895b99b99c4a94c80899417ef555bbdfca54aafea118192bf10b15cb"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-kou-21.133-kourovka-notebook-problem-21.133-e2eb4702-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-kou-21.133-kourovka-notebook-problem-21.133-e2eb4702-root",
      "route_id": "route:um-kou-21.133-kourovka-notebook-problem-21.133-e2eb4702-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kou-21.133-3da9baae1241",
        "url": "https://www.unsolvedmath.com/problems/KOU-21.133"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
